var articlesController = app.controller("articlesController", ['$scope', '$http', '$stateParams', '$sce', '$rootScope', 'articleService', function($scope, $http, $stateParams, $sce, $rootScope, articleService) {
    $scope.largeArticle = "";
    $scope.keywords = [];
